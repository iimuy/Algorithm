...
public func testPersonArrayList(){
    ...
    let _ = arrayList.remove(index: 0)
    print("移除下标11:\(arrayList)")
    
    arrayList.add(element: person02)
    print("添加下标22: \(arrayList)")
    
    let _ = arrayList.remove(element: person02)
    print("移除下标22:\(arrayList)")
    
    let _ = arrayList.remove(element: nil)
    print("移除下标33:\(arrayList)")
}
